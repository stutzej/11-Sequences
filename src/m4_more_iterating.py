...
def run_test_count_positive_sines():
    ...
    # DONE6 (continued):  Add your 1 ADDITIONAL test here:
    # Test 11:
    expected = 4
    actual = count_positive_sines([3, 4, 5, 6, 7, 8, 9])
    print()
...
def run_test_sum_first_n():
    ...
    # DONE8 (continued):  Add your 2 ADDITIONAL tests here:
    # Test 8:
    expected = 63
    actual = sum_first_n([48, -30, 40, 5], 4)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    # Test 9:
    expected = 58
    actual = sum_first_n([48, -30, 40, 5], 3)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
